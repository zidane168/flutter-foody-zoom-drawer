                      ...
                      child: Stack (    // de co the sap xep nhieu cai trong nhau trong màn hình
                        children: [
                          ...
                          Positioned(
                            top: 0,
                            right: 0,
                            child: Consumer<LikeProvider>(    // lang nghe provider
                              builder: (BuildContext context, LikeProvider value, Widget? child) {

                              },
                              child: LikeButton(   // like button co hieu ung dep
                                onTap: (like) {
